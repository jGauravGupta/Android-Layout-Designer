...
@Component(name = "Button",
        icon = "org/netbeans/android/resource/library/icon/Button.png",
        fxml = "org/netbeans/android/resource/library/fxml/Button.fxml",
        serialize = BUTTON,
        listener = @Listener(resize = ResizeListener.class))
public class Button extends javafx.scene.control.Button implements SourceSerializer<FXOMInstance, XMLBuffer>, IResizer, org.netbeans.jfluidon.component.Widget {
    ...
    private static final Insets DEFAULT_PADDING = new Insets(3, 21, 4, 21);
    ...
    public void serialize(FXOMInstance reader, XMLBuffer writer) {
        ...
        ComponentUtil.evalPadding(resourcePadding, writer, wrapperComponent);
    }
